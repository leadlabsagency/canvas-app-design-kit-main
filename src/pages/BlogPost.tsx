  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <div className="w-full h-[400px] bg-cover bg-center" style={{ backgroundImage: `url(${post.image})` }}>
          <div className="w-full h-full flex items-end bg-gradient-to-t from-black/70 to-transparent">
            <div className="max-w-4xl mx-auto px-4 md:px-8 py-12 text-white">
              <Link to="/blog" className="inline-flex items-center text-white hover:text-twello-blue mb-4 transition-colors">
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-8 py-12">
          ...
          <Card className="mt-12">
            <CardContent className="p-6">
              ...
              <p className="mt-4">Jane is a digital marketing expert with over 10 years of experience in affiliate marketing strategies. She helps businesses maximize their affiliate partnerships and revenue.</p>
            </CardContent>
          </Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {relatedPosts.map(post => (
                <Link key={post.id} to={`/blog/${post.id}`} className="group">
                  ...
                  <h3 className="font-semibold group-hover:text-twello-blue transition-colors">{post.title}</h3>
