...
const OfferDetails = () => {
  ...
  useEffect(() => {
    ...
    const offerData = {
      ...
      trackingLink: 'https://example.com/tracking?aff={AFFID}&source={SOURCE}',
      epc: '$1.45',
      conversion: '4.2%',
      category: 'Finance',
      expiry: 'Ongoing',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <Card className="p-6 mb-8">
              ...
              <h3 className="font-semibold text-lg mb-3">Tracking Link</h3>
              <div className="flex items-center mb-6">
                <div className="flex-1 bg-gray-50 border rounded-l px-4 py-2 text-sm font-mono overflow-x-auto">
                  {offer.trackingLink}
                </div>
                <Button 
                  variant="outline" 
              ...
              <p className="text-sm text-gray-500 mb-6">
                Replace <code>{"{AFFID}"}</code> with your affiliate ID and <code>{"{SOURCE}"}</code> with your traffic source.
              </p>
            </Card>
            ...
            <Card className="p-6 mb-8">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="font-medium mb-3">Banner Ads</h3>
                ...
                <div>
                  <h3 className="font-medium mb-3">Email Templates</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {[1, 2].map((i) => (
                      <div key={i} className="border rounded p-3">
                        <div className="font-medium mb-1">Email Template {i}</div>
                        <div className="text-sm text-gray-500 mb-2">Subject: Get started with crypto trading</div>
          ...
          <div>
            ...
            <Card className="p-6 bg-gray-50">
              <h3 className="font-semibold text-xl mb-4 flex items-center">
                <Shield size={18} className="mr-2 text-twello-purple" />
                Important Information
              </h3>
              <ul className="space-y-3 text-sm">
                <li className="flex items-start">
                  <Clock size={16} className="mr-2 text-gray-500 flex-shrink-0 mt-0.5" />
                  <span>
                    <span className="font-medium">Expiry:</span> {offer.expiry}
                  </span>
                </li>
                <li className="flex items-start">
                  <AlertTriangle size={16} className="mr-2 text-amber-500 flex-shrink-0 mt-0.5" />
                  <span>
                    This offer requires approval from the network before you can promote it.
                  </span>
                </li>
                <li className="flex items-start">
                  <Check size={16} className="mr-2 text-green-500 flex-shrink-0 mt-0.5" />
                  <span>
                    <span className="font-medium">Payment terms:</span> Net-15 days
                  </span>
                </li>
              </ul>
            </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[1, 2, 3].map((i) => (
              <Card key={i} className="overflow-hidden card-hover">
                <div className="p-6">
                  <h3 className="font-semibold text-lg mb-3">Similar Offer {i}</h3>
