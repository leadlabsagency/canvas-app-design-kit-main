      ...
      <main className="flex-grow">
        ...
        <div className="bg-gradient-to-r from-twello-blue to-twello-purple py-16">
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white text-center">Twello Blog</h1>
            <p className="text-xl text-white text-center mt-4 max-w-3xl mx-auto">
              Insights, strategies, and news for affiliate marketers.
            </p>
          </div>
        </div>
              ...
              <Card key={post.id} className="flex flex-col h-full hover:shadow-lg transition-shadow">
                ...
                <CardHeader>
                  <div className="flex items-center gap-2 mb-2">
                    <span className="text-sm font-medium text-twello-blue">{post.category}</span>
                    <span className="text-gray-400">•</span>
                    <span className="text-sm text-gray-500">{post.date}</span>
                  </div>
                  <CardTitle className="text-xl font-bold">
                    <Link to={`/blog/${post.id}`} className="hover:text-twello-blue transition-colors">
                      {post.title}
                    </Link>
                  </CardTitle>
                </CardHeader>
                ...
                <CardFooter className="pt-0 border-t border-gray-100 mt-4">
                  <div className="flex justify-between items-center w-full">
                    ...
                    <Button variant="ghost" size="sm" className="text-twello-blue hover:bg-twello-blue/10">
