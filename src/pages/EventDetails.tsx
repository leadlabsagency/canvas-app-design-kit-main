  ...
  useEffect(() => {
    ...
    const eventData = {
      ...
      speakers: [
        {
          name: 'Jane Smith',
          title: 'CMO at AffiliateGrid',
          topic: 'Future of Performance Marketing',
          image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&q=80'
        },
        {
          name: 'Michael Johnson',
          title: 'Founder of GrowthHackers',
          topic: 'Scaling Affiliate Campaigns',
          image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&q=80'
        },
        {
          name: 'Sarah Williams',
          title: 'Head of Partnerships at MaxBounty',
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {event.speakers.map((speaker: any, index: number) => (
                  <div key={index} className="text-center">
                    ...
                    <div className="text-sm text-gray-600 mb-1">{speaker.title}</div>
            ...
            {[1, 2, 3].map((i) => (
              <Card key={i} className="overflow-hidden card-hover">
                <div className="p-1">
                  ...
                  <div className="p-4">
                    <h3 className="font-semibold text-lg mb-1">Event Name {i}</h3>
                    <div className="flex items-center text-sm text-gray-500 mb-3">
                      <Calendar size={14} className="mr-1" />
                      June 1{i}, 2025
                    </div>
                    <p className="text-sm text-gray-600 mb-4 line-clamp-2">
                      Short description about this upcoming event in the affiliate marketing industry.
                    </p>
